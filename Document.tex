...
\usepackage{placeins} % Pour que les figures ne flottent que dans les bonnes sections
...
\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth]{images/merge_branche.JPG}
...
\FloatBarrier % FIGURES, YOU SHALL NOT PASS!
\newpage
